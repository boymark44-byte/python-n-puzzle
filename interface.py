...
class InterfaceApp:
    ...
    def __init__(self, master=None):
        ...
        self.mainlabel.configure(
            anchor="center", font="{Impact} 36 {bold}", foreground="#007FFF", justify="center", text='8-Piece Puzzle Solver')
        ...
        self.solvebutton.configure(cursor="hand2", text='Analyze')
        self.solvebutton.place(anchor="s", height=50, width=150, x=700, y=150)
        self.solvebutton.bind("<ButtonPress>", self.analyze)

        self.analyzebutton = ttk.Button(self.appFrame)
        self.analyzebutton.configure(cursor="hand2", text='Solve')
        self.analyzebutton.place(anchor="s", height=50, width=150, x=700, y=200)
        self.analyzebutton.bind("<ButtonPress>", self.solve)
        ...
        self.cell0.configure(anchor="center", background="#FFF8DC", borderwidth=3,
        ...
        self.cell1.configure(anchor="center", background="#FFF8DC", borderwidth=3,
        ...
        self.cell2.configure(anchor="center", background="#FFF8DC", borderwidth=3,
        ...
        self.cell3.configure(anchor="center", background="#FFF8DC", borderwidth=3,
        ...
        self.cell4.configure(anchor="center", background="#FFF8DC", borderwidth=3,
        ...
        self.cell5.configure(anchor="center", background="#FFF8DC", borderwidth=3,
        ...
        self.cell6.configure(anchor="center", background="#FFF8DC", borderwidth=3,
        ...
        self.cell7.configure(anchor="center", background="#FFF8DC", borderwidth=3,
        ...
        self.cell8.configure(anchor="center", background="#FFF8DC", borderwidth=3,
    ...
    def analyze(self, event=None):
        ...
        app.gif_loading.place(x=600, y=170, anchor="s")
    ...
    def solve(self, event=None):
        """
        Function is invoked at pressing the solve button. Solves the puzzle on sync with the runtime.
        """
        global statepointer
        self.stopFastForward()
        if statepointer < cost:
            ...
            statepointer += 1
            ms = runtime/cost
            app._job = app.stepCount.after(round(ms * 1000), self.fastForward)
        else:
            self.stopFastForward()
...
if __name__ == "__main__":
    global app
    root = tk.Tk()
    root.title('8-Piece Puzzle Solver')
